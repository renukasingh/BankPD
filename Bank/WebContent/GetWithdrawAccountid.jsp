...
function chkinput()
{
var account_id = document.WithdrawForm.account_id.value;
var letters = /^[0-9]+$/;
if(account_id != null && account_id.length > 0)
	{
	 if(!letters.test(account_id))
		 ...
		 document.WithdrawForm.account_id.focus();
		 return false;
		 }
	}
else {
...
<div class="css-top">
	...
	<form class=" css-container css-card-4 css-center css-padding-jumbo" method="post" action="/Bank/WithdrawController" name="Withdrawform">
